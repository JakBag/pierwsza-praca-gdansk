  ...
  return (
    <section className="bg-gradient-to-r from-blue-600 to-blue-500 text-white">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12 sm:py-20 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        <div>
          <h1 className="text-3xl sm:text-4xl font-bold leading-tight">Praca dla studentow w Trojmiescie.</h1>
          <p className="mt-4 text-base sm:text-lg">Znajdz pierwsza prace bez doswiadczenia. Bez CV.</p>
          <p className="mt-2 text-blue-100">
            Tylko oferty dla studentow: praca dorywcza, na pol etatu i praca weekendowa.
          </p>
