...
export const metadata: Metadata = {
  title: {
    absolute: "Praca dla studentów w Trójmieście | Pierwsza Praca",
  },
  description:
    ...
    <>
      ...
      <main className="bg-slate-50">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-10 sm:py-12">
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Praca dla studentów w Trójmieście</h1>
